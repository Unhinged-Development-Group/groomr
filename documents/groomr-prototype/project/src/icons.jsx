// Brand-pattern icons + Heroicon-style utility glyphs.
...
const ChevronRight= (p) => <Stroke {...p} d={["M9 5l7 7-7 7"]}/>;
const ChevronLeft = (p) => <Stroke {...p} d={["M15 19l-7-7 7-7"]}/>;
...
const MessageIcon = (p) => <Stroke {...p} d={["M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z"]}/>;
const UploadIcon  = (p) => <Stroke {...p} d={["M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4","M17 8l-5-5-5 5","M12 3v12"]}/>;
const PencilIcon  = (p) => <Stroke {...p} d={["M12 20h9","M16.5 3.5a2.121 2.121 0 113 3L7 19l-4 1 1-4 12.5-12.5z"]}/>;
const TrashIcon   = (p) => <Stroke {...p} d={["M3 6h18","M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2","M19 6l-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6","M10 11v6","M14 11v6"]}/>;

Object.assign(window, {
  PetsIcon, ScissorsIcon, CalendarIcon, PinIcon, ShieldIcon, HeartIcon,
  SearchIcon, ChevronIcon, ChevronRight, ChevronLeft, CloseIcon, ClockIcon,
  PlusIcon, MenuIcon, CheckIcon, StarIcon, MessageIcon, UploadIcon,
